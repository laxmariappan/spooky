...
const Header = () => (
  <>
  <div className=" mx-auto px-5 md:px-12 max-w-6xl relative items-center w-full">
    <div className="navbar mb-2 shadow-lg bg-neutral text-neutral-content rounded-box">
      <div className="px-2 mx-2 navbar-start">
        <span className="text-lg md:text-4xl font-bold font-spooky">
                Spooky
        </span>
      </div> 
      <div className="hidden px-2 mx-2 navbar-center lg:flex">
        <div className="flex items-stretch">
          ...
          <a href="/register" className="btn btn-ghost btn-sm rounded-btn">
                  Register
                </a> 
